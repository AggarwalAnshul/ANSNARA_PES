...
<body >
	...
	<p class="text"> Delete Question(JAVA) </p>
...
<div class="bgded overlay" style="background-image: url('images/demo/backgrounds/question.jpg')">
	...
	<%
		...
		ResultSet rs = st.executeQuery("select * from javaquestion");
		while (rs.next()) {
			i+=1;
	...
	%>
     	...
     	<br><p class="delete"> Que:<%= queno   %> 	<%=   question %> </p>
 <%} %>
  <form action="process_delete.jsp" method="get">
     <center>
     <input type="numbers" id="deleteq" align="center" name="deleteq" placeholder="Enter Question No..">
     <input type="submit" placeholder="Delete" name="delete"><br><br>
	</center>
